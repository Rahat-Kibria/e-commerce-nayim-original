...
// User registration
Route::get('/user/register',[IndexController::class,'registerForm'])->name('user.register');
Route::post('/user/register',[IndexController::class,'user_create'])->name('auth_user.store');
...
// Logout Route
Route::get('/logout', [AdminSetiingController::class, 'Logout'])->name('admin.logout');
Route::get('/web/dashboard', [SiteController::class, 'Logout'])->name('logout');
...
//   site setting
Route::get('sitesetiing', [AdminSetiingController::class, 'getSetting'])->name('setting');
Route::post('sitesetiing/update/{id}', [AdminSetiingController::class, 'updateSetting'])->name('update.setting');

Route::get('admin/profile/', [AdminSetiingController::class, 'adminprofile'])->name('adminprofile');
Route::post('admin/update/{id}', [AdminSetiingController::class, 'updateadminprofile'])->name('update.adminprofile');
