            ...
            <div class="col-md-8  rounded  ">
              <div class="card p-3">
                <div class="contact_form_container">
                    <h3 class="contact_form_title text-center">User Update Profile</div>
                        ...
                        @csrf
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                <div class="controls">
                                    <img  src="{{ (!empty($user->avater)) ?url('upload/user_profile/'.$user->avater):url('upload/no-image.jpg') }}" class="rounded" id="showimage" alt="" style="width: 80px;height:80px;">
