    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
          ...
          <div class="card" style="width:100%">
            ...
            <form class="forms-sample" action="{{ route('update.setting',['id'=>$setting->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number"name="shipping_charge" value="{{$setting->shipping_charge}}">
                          </div>
                    </div>
                </div>
                {{-- end row --}}
