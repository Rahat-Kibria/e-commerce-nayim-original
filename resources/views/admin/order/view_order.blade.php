    ...
    <div class="sl-mainpanel">
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                                ...
                                <tbody>
                                    @foreach ($orderdetails as $row)
                                        <tr>
                                            ...
                                            <td> <img src="{{ asset($row->image_one) }}" height="50px;" width="50px;">
                                            </td>
                                            <td>{{ $row->color }}</td>
                                            <td>{{ $row->size }}</td>
                                            <td>{{ $row->quantity }}</td>
                ...
                @if ($order->status == 0)
                    <a href="{{ route('payment.accept', ['id' => $order->id]) }}" class="btn btn-info">Accept</a>
                    <a href="{{ route('payment.cancel', ['id' => $order->id]) }}" class="btn btn-danger">Cancel Order </a>
                @elseif($order->status == 1)
                    <a href="{{ route('process.delivary', ['id' => $order->id]) }}" class="btn btn-info">Process</a>
                @elseif($order->status == 2)
                    <a href="{{ route('delivary.done', ['id' => $order->id]) }}" class="btn btn-success">Complete delivery</a>
