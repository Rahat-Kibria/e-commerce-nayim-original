...
@endphp
<div class="sl-logo"><a href="{{ URL('/admin/dashboard') }}"><img src="{{ asset('upload/site/'.$adminLogo->logo) }}" alt="" style="width:50px;" ></a></div>
<div class="sl-sideleft">
    ...
    <div class="sl-sideleft-menu">
      ...
      <a href="#" class="sl-menu-link">
        ...
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('category.view') }}" class="nav-link">View Categories</a></li>
            <li class="nav-item"><a href="{{ route('subcategory.view') }}" class="nav-link"> View Subcategories</a></li>
    ...
    @endif
      ...
      <a href="#" class="sl-menu-link">
        ...
        <ul class="sl-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="{{ route('accept.payment') }}" class="nav-link">Accepted Orders</a></li>
            <li class="nav-item"><a href="{{ route('cancel.payment') }}" class="nav-link">Canceled Orders</a></li>
            <li class="nav-item"><a href="{{ route('process.payment') }}" class="nav-link">Process Delivery</a></li>
            <li class="nav-item"><a href="{{ route('delivared.payment') }}" class="nav-link">Delivered Orders</a></li>
          </ul>
      </a><!-- sl-menu-link -->
      @else
      @endif
     ...
     <a href="#" class="sl-menu-link">
        ...
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('today.order') }}" class="nav-link">Today's Orders</a></li>
            <li class="nav-item"><a href="{{ route('today.delivary') }}" class="nav-link">Today's Delivery</a></li>
            <li class="nav-item"><a href="{{ route('this.month') }}" class="nav-link">This Month's Orders</a></li>
            <li class="nav-item"><a href="{{ route('search.report') }}" class="nav-link">Search Reports</a></li>
   ...
   <a href="#" class="sl-menu-link">
    ...
    <ul class="sl-menu-sub nav flex-column">
        <li class="nav-item"><a href="{{ route('admin.return.rquest') }}" class="nav-link">Return Requests</a></li>
        <li class="nav-item"><a href="{{ route('admin.return.allrequest') }}" class="nav-link">All Requests</a></li>
      </ul>
  </a><!-- sl-menu-link -->
   @else
   @endif
