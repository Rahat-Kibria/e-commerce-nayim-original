...
class PaymentController extends Controller
{
  public function Payment(Request $request)
  {
    ...
    } elseif ($request->payment == 'cash-on') {
  ...
  public function StripeCharge(Request $request)
  {
    ...
    session()->flash('message', 'Order Process Successfully Done');
    ...
    $order = DB::table('orders')
      ...
      ->first();
    $shippings = DB::table('shippings')->where('order_id', $order_id)->first();
    ...
    $orderdetails = DB::table('order_details')
      ...
      ->get();
    return view('frontend.pages.order_complete', compact('order', 'shippings', 'orderdetails'));
  }
  ...
  public function OnCashCharge(Request $request)
  {
    ...
    session()->flash('message', 'Order Place Successfully Done');
    session()->flash('alert-type', 'success');
